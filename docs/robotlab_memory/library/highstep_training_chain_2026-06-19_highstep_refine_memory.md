...
Continue from `model_69998.pt` before changing teacher. If mild backward distillation does not reduce rearing/bad orientation, then revisit teacher command distribution.

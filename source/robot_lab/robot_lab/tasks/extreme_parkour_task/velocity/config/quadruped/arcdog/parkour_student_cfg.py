...
from robot_lab.terrains.ray.extreme_parkour.extreme_parkour_terrains_cfg import ExtremeParkourRoughTerrainCfg
from robot_lab.envs import ParkourManagerBasedRLEnvCfg
# from ....parkour_mdp_cfg import * 
from robot_lab.tasks.extreme_parkour_task.velocity.parkour_mdp_cfg import *
from robot_lab.tasks.extreme_parkour_task.velocity.default_cfg import CAMERA_USD_CFG, CAMERA_CFG, VIEWER
...
@configclass
class ArclabArcdogStudentParkourEnvCfg(ParkourManagerBasedRLEnvCfg):
...
@configclass
class ArclabArcdogStudentParkourEnvCfg_EVAL(ArclabArcdogStudentParkourEnvCfg):
    viewer = VIEWER 
...
@configclass
class ArclabArcdogStudentParkourEnvCfg_PLAY(ArclabArcdogStudentParkourEnvCfg_EVAL):

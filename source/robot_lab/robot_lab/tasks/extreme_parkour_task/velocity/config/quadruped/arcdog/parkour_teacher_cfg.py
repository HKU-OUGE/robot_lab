...
# Pre-defined configs
##
from robot_lab.terrains.ray.extreme_parkour.config.parkour import EXTREME_PARKOUR_TERRAINS_CFG  # isort: skip
...
from robot_lab.tasks.extreme_parkour_task.velocity.default_cfg import ParkourDefaultSceneCfg, VIEWER
...
@configclass
class ArclabArcdogTeacherParkourEnvCfg(ParkourManagerBasedRLEnvCfg):
...
@configclass
class ArclabArcdogTeacherParkourEnvCfg_EVAL(ArclabArcdogTeacherParkourEnvCfg):
    viewer = VIEWER 
...
@configclass
class ArclabArcdogTeacherParkourEnvCfg_PLAY(ArclabArcdogTeacherParkourEnvCfg_EVAL):
    viewer = VIEWER 

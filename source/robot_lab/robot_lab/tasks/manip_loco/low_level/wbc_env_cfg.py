...
from .mdp_wbc import observations, rewards,commands_cfg
##
# Pre-defined configs
##
...
class MySceneCfg(InteractiveSceneCfg):
    ...
    terrain = TerrainImporterCfg(
        ...
        terrain_generator=WBC_BASE_TERRAINS_CFG,
...
class RewardsCfg:
    ...
    end_effector_position_tracking = RewTerm(
        func=rewards.tracking_ee_position_command_error_exp,
        weight=2.5,
    ...
    end_effector_orientation_tracking = RewTerm(
        func=rewards.tracking_ee_orientation_command_error,
        weight=-1.5,
        params={"asset_cfg": SceneEntityCfg("robot", body_names="gripper_base"), 
                "command_name": "ee_pose"},
    )
    ...
    dof_torques_l2 = RewTerm(func=rewards.joint_torques_l2_Quadruped, weight=-2.0e-5) # - 0.0002
    dof_acc_l2 = RewTerm(func=rewards.joint_acc_l2_Quadruped, weight=-2.5e-7)
    action_rate_l2 = RewTerm(func=rewards.action_rate_l2_Quadruped, weight=-0.01)
    ...
    height_reward = RewTerm(func=rewards.base_height_l2, weight=-2.0, params={"target_height": 0.455})
...
class TerminationsCfg:
    ...
    hip_contact = DoneTerm(
        func=mdp.illegal_contact,
        params={"sensor_cfg": SceneEntityCfg("contact_forces", body_names=".*_hip"), "threshold":0.5},
    )

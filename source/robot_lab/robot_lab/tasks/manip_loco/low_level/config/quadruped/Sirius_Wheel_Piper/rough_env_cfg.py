...
from robot_lab.tasks.manip_loco.low_level.sirius_wheel_piper_lab_env_cfg import ActionsCfg, ManipulationLocomotionEnvCfg, RewardsCfg, CommandsCfg, ObservationsCfg, TerminationsCfg
...
# Pre-defined configs
##
from robot_lab.assets.cuhklrl import CUHKLRL_SIRIUS_WHEEL_PIPER_CFG  # isort: skip
...
@configclass
class CUHKLRLSiriusWPiperActionsCfg(ActionsCfg):
...
class CUHKLRLSiriusWPiperCommandsCfg(CommandsCfg):
    ...
    # )
@configclass
class CUHKLRLSiriusWPiperTerminationsCfg(TerminationsCfg):
    terminate = None


@configclass
class CUHKLRLSiriusWPiperRewardsCfg(RewardsCfg):
...
@configclass
class CUHKLRLSiriusWPiperObservationsCfg(ObservationsCfg):
    """Reward terms for the MDP."""
    @configclass
...
@configclass
class CUHKLRLSiriusWPiperRoughEnvCfg(ManipulationLocomotionEnvCfg):
    actions: CUHKLRLSiriusWPiperActionsCfg = CUHKLRLSiriusWPiperActionsCfg()
    rewards: CUHKLRLSiriusWPiperRewardsCfg = CUHKLRLSiriusWPiperRewardsCfg()
    commands: CUHKLRLSiriusWPiperCommandsCfg = CUHKLRLSiriusWPiperCommandsCfg()
    observations: CUHKLRLSiriusWPiperObservationsCfg = CUHKLRLSiriusWPiperObservationsCfg()
    terminations: CUHKLRLSiriusWPiperTerminationsCfg = CUHKLRLSiriusWPiperTerminationsCfg()
    ...
    def __post_init__(self):
        ...
        # self.actions.arm_pose.joint_names = self.arm_joint_names
        ...
        if self.__class__.__name__ == "CUHKLRLSiriusWPiperRoughEnvCfg":

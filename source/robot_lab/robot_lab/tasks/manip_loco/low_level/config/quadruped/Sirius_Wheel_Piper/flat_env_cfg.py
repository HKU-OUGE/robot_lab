...
from .rough_env_cfg import CUHKLRLSiriusWPiperRoughEnvCfg
from isaaclab.terrains import TerrainImporterCfg
from isaaclab.assets import RigidObjectCfg
@configclass
class CUHKLRLSiriusWPiperFlatEnvCfg(CUHKLRLSiriusWPiperRoughEnvCfg):
    def __post_init__(self):
        ...
        self.rewards.end_effector_position_tracking.weight = 1.0 #2.5
        ...
        if self.__class__.__name__ == "CUHKLRLSiriusWPiperFlatEnvCfg":

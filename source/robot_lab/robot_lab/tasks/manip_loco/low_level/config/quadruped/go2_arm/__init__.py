...
gym.register(
    id="RobotLab-Isaac-ManipLocoLowLevel-Go2Arm-Flat",
...
gym.register(
    id="RobotLab-Isaac-ManipLocoLowLevel-Go2Arm-Flat-Play",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="RobotLab-Isaac-ManipLocoLowLevel-Go2Arm-Rough",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="RobotLab-Isaac-ManipLocoLowLevel-Go2Arm-Rough-Play",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={

...
from robot_lab.assets.arclab_atec import ARCLAB_ATEC_CFG  # isort: skip


@configclass
class CUHKLRLSiriusPiperLowLevelRoughEnvCfg(LowLevelEnvCfg):
    base_link_name = "base"
    ...
    #     "waist","shoulder","forearm_roll",
    #     "wrist_angle","wrist_rotate","elbow",
    # ]
    
    # joint_names = ["waist","shoulder","forearm_roll",
    #     "wrist_angle","wrist_rotate","elbow",
    #     "FL_hip_joint", "FR_hip_joint", "RL_hip_joint",
    #     "RR_hip_joint", "FL_thigh_joint", "FR_thigh_joint",
    #     "RL_thigh_joint", "RR_thigh_joint", "FL_calf_joint",
    ...
    def __post_init__(self):
        ...
        # ------------------------------Events------------------------------
        self.events.randomize_base_mass.params["asset_cfg"].body_names = [
            self.base_link_name
        ]

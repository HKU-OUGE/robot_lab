...
@configclass
class CUHKLRLSiriusWPiperRoughPPORunnerCfg(RslRlOnPolicyRunnerCfg):
    num_steps_per_env = 24
    max_iterations = 20000
    save_interval = 100
    experiment_name = "cuhkrl_siriusw_piper_rough"
...
@configclass
class CUHKLRLSiriusWPiperFlatPPORunnerCfg(CUHKLRLSiriusWPiperRoughPPORunnerCfg):

# Copyright (c) 2025-2026 Rui HUANG
...
if TYPE_CHECKING:
    ...
    # from low_level_env_cfg import ManagerRLEnv



def tracking_ee_position_command_error_exp(env: ManagerBasedRLEnv, command_name: str, std: float, asset_cfg: SceneEntityCfg) -> torch.Tensor:
...
def tracking_ee_orientation_command_error(env: ManagerBasedRLEnv, command_name: str, asset_cfg: SceneEntityCfg) -> torch.Tensor:

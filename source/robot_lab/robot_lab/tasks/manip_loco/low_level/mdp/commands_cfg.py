...
class UniformPoseCommandCfg(CommandTermCfg):
    ...
    class_type: type = commands.UniformPoseCommand
    ...
    """
    is_QuadrupedARM: bool = False
    """QuadrupedArm curriculum flag.
    check pose_command.py for more details
    """

    curriculum_coeff: float = 1.0
    """   max curriculum iteration for the pose command, which is valid when is_QuadrupedArm = True
    Optimal accuracy is achieved at num_env=4096, while other settings may lead to suboptimal results.
    check pose_command.py for more details
    """

    is_QuadrupedARM_Play: bool = False
    """QuadrupedArm curriculum flag.
    check pose_command.py for more details
    """
    ...
    """Ranges for the commands,  which is valid when is_QuadrupedArm = False."""

    ranges_init: Ranges = None
    """The initial range, which is valid when is_QuadrupedArm = True."""

    ranges_final: Ranges = None
    """The maximum range, which is valid when is_QuadrupedArm = True."""
...
class UniformVelocityCommandCfg(CommandTermCfg):
    ...
    class_type: type = commands.UniformVelocityCommand
    ...
    ranges: Ranges = MISSING
    """Distribution ranges for the velocity commands, which is valid when is_QuadrupedArm = False."""
    ...
    curriculum_coeff: float = 1.0
    """max curriculum iteration for the velocity command, which is valid when is_QuadrupedArm = True.
    Optimal accuracy is achieved at num_env=4096, while other settings may lead to suboptimal results.
    check velocity_command.py for more details"""

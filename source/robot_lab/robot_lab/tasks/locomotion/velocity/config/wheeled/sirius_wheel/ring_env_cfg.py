...
class CUHKLRLSiriusWRingEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.rewards.joint_acc_wheel_l2.weight = -5e-9
        ...
        self.rewards.abad_joint_pos_penalty.weight = -3.0
        ...
        self.rewards.track_ang_vel_z_exp.params["std"] = 0.2
        ...
        self.rewards.upward.weight = 1.2

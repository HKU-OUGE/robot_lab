...
class CUHKLRLSiriusWRewardsCfg(RewardsCfg):
    ...
    knee_undesired_contacts = RewTerm(
        ...
        weight=0.0,
        params={"sensor_cfg": SceneEntityCfg("contact_forces", body_names=""), "threshold": 9.8},
    )
    climb_progress = RewTerm(
        func=mdp.climb_progress_dyn_pbrs,
        weight=0.0,   # 纯奖励；若只想作为 shaping，可设小一点
        params={
            "asset_cfg": SceneEntityCfg("robot"),
...
class CUHKLRLSiriusWRingEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.scene.terrain.terrain_generator=EASY_BOX_TERRAINS_CFG
        ...
        self.rewards.joint_vel_wheel_l2.weight = -3.0e-4

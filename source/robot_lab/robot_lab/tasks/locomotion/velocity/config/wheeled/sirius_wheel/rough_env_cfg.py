...
class CUHKLRLSiriusWRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.events.randomize_rigid_body_material.params["dynamic_friction_range"] = (1.2, 1.2)
        ...
        self.rewards.joint_acc_l2.weight = -2.5e-9
        ...
        self.rewards.wheels_stop_without_cmd.weight = 0.00

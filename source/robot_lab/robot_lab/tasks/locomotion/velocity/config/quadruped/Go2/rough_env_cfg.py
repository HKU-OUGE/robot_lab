...
# use local assets
from robot_lab.assets.arclab import UNITREE_GO2_CFG  # isort: skip
from isaaclab.terrains.config.rough import ROUGH_TERRAINS_CFG  # isort:skip


@configclass
class ArclabGo2RoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    base_link_name = "base"
    ...
    def __post_init__(self):
        ...
        self.rewards.feet_height_body_exp.params["target_height"] = -0.20

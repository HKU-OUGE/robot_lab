...
class ArclabArcdogAdjustableLegBodyflatEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.scene.terrain.physics_material.static_friction = 1.5                # 提高基础静摩擦力
        self.scene.terrain.physics_material.dynamic_friction = 1.5               # 提高基础动摩擦力
        ...
        self.events.randomize_push_robot.params["asset_cfg"] = SceneEntityCfg("robot")

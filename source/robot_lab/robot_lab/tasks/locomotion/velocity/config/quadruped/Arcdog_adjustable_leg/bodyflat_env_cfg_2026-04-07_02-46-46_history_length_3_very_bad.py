...
class ArclabArcdogAdjustableLegBodyflatEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.rewards.box_joint_pos_limits.weight = -4.0 
        # 禁止超速
        ...
        self.rewards.box_joint_action_rate.weight = -0.2
        ...
        self.rewards.stand_still_joint_vel.weight = -0.1
        self.rewards.stand_still_base_ang_vel.weight = -1
        self.rewards.stand_still_base_lin_vel.weight = -1
